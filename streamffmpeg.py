...
video_path = "videoSamples/sample_1280x720.mpeg"
video_path = "videoSamples/dayflight.mpg"
video_stream_cmd = ['ffmpeg', '-i', video_path, '-map', '0:0',  '-f', 'image2pipe', '-pix_fmt', 'bgr24', '-codec', 'rawvideo', '-']
...
klv_stream_cmd = ['ffmpeg', '-i', video_path, '-map', '0:1',  '-f', 'data', '-codec', 'copy', '-']
